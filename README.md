...
ShotShorts берёт длинное видео (например, подкаст или запись стрима), с помощью **NVIDIA Nemotron AI** находит в нём отдельные истории/сегменты, транскрибирует аудио через **Whisper**, накладывает **субтитры** и ADHD-фон, и автоматически собирает **вертикальные видео 1080×1920** — готовый контент для TikTok, YouTube Shorts и Instagram Reels.
