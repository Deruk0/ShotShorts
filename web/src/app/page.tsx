...
export default function Home() {
  return (
    <div className="flex min-h-screen bg-black font-mono text-white selection:bg-orange-500 selection:text-black">
      <main className="grid w-full grid-cols-1 md:grid-cols-12 min-h-screen">
        
        {/* Left/Top Content Area */}
        <div className="col-span-1 border-b border-zinc-800 p-8 md:col-span-8 md:border-b-0 md:border-r flex flex-col justify-between">
          <div className="mb-12">
            <img
              className="invert"
              src="/images/logo.png"
          ...
          <div className="flex flex-col gap-6 max-w-2xl">
            ...
            <p className="text-xl leading-relaxed text-zinc-400">
              Agent templates with Skills, Agents, and Workflows for{" "}
              <a
                href="https://antigravity.google/t"
                className="inline-flex items-center align-middle focus:outline-none focus:ring-2 focus:ring-orange-500"
                target="_blank"
                rel="noopener noreferrer"
              >
                <span className="sr-only">Antigravity Google</span>
                <AntigravityGoogle />
              </a>
            </p>
          </div>
          
          <div className="mt-24 text-sm text-zinc-600 uppercase tracking-widest hidden md:block">
        ...
        <div className="col-span-1 flex flex-col justify-end p-8 bg-zinc-950 md:col-span-4 gap-4">
          ...
          <Link
            className="flex h-16 w-full items-center justify-between border border-zinc-700 bg-white px-6 text-sm uppercase tracking-wider text-black transition-all hover:bg-orange-500 hover:border-orange-500 focus:outline-none focus:ring-2 focus:ring-orange-500"
            href="/docs"
          >
